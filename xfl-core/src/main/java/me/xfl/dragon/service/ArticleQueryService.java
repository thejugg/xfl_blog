...
import static me.xfl.dragon.model.Article.ARTICLE;
import static me.xfl.dragon.model.Article.ARTICLES;
import static me.xfl.dragon.model.Article.ARTICLE_ABSTRACT;
import static me.xfl.dragon.model.Article.ARTICLE_AUTHOR_EMAIL;
import static me.xfl.dragon.model.Article.ARTICLE_COMMENT_COUNT;
import static me.xfl.dragon.model.Article.ARTICLE_CONTENT;
import static me.xfl.dragon.model.Article.ARTICLE_CREATE_DATE;
import static me.xfl.dragon.model.Article.ARTICLE_CREATE_TIME;
import static me.xfl.dragon.model.Article.ARTICLE_EDITOR_TYPE;
import static me.xfl.dragon.model.Article.ARTICLE_IS_PUBLISHED;
import static me.xfl.dragon.model.Article.ARTICLE_PUT_TOP;
import static me.xfl.dragon.model.Article.ARTICLE_RANDOM_DOUBLE;
import static me.xfl.dragon.model.Article.ARTICLE_TAGS_REF;
import static me.xfl.dragon.model.Article.ARTICLE_UPDATE_DATE;
import static me.xfl.dragon.model.Article.ARTICLE_VIEW_COUNT;
...
import me.xfl.dragon.model.Sign;
...
import me.xfl.dragon.repository.impl.ArchiveDateArticleRepositoryImpl;
import me.xfl.dragon.repository.impl.ArticleRepositoryImpl;
import me.xfl.dragon.repository.impl.TagArticleRepositoryImpl;
import me.xfl.dragon.repository.impl.TagRepositoryImpl;
import me.xfl.dragon.util.Articles;
import me.xfl.dragon.util.Markdowns;
...
public final class ArticleQueryService {
	...
	public JSONObject getArticles(final JSONObject requestJSONObject) throws ServiceException {
		...
		try {
			...
			final Query query = new Query().setCurrentPageNum(currentPageNum).setPageSize(pageSize)
					.addSort(ARTICLE_PUT_TOP, SortDirection.DESCENDING).addSort(ARTICLE_CREATE_DATE, SortDirection.DESCENDING)
					.setFilter(new PropertyFilter(ARTICLE_IS_PUBLISHED, FilterOperator.EQUAL, articleIsPublished));
	...
	/**
	 * Gets <em>published</em> articles by the specified author email, current
	...
	public List<JSONObject> getArticlesByAuthorEmail(final String authorEmail, final int currentPageNum, final int pageSize)
		...
		try {
			...
			LOGGER.log(Level.SEVERE, "Gets articles by author email failed[authorEmail=" + authorEmail + ", currentPageNum="
	...
	/**
	 * Converts the content and abstract for each of the specified articles to
	 * HTML if that is saved by Markdown editor.
	 * 
	 * @param articles
	...
	/**
	 * Converts the content and abstract for the specified article to HTML if it
	 * is saved by Markdown editor.
	 * 
	 * @param article
	 *            the specified article
	 * @throws Exception
