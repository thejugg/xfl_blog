...
public interface Cache<K extends Serializable, V extends Serializable> {
	 ...
	 * 
	 * @param maxCount
	 *            the maximum count of this cache
	 */
	 ...
	 * 
	 * @return hit count of this cache, returns {@code -1} if cache is
	 *         unavailable.
	 */
	long getHitCount();
	 ...
	 * 
	 * @return miss count of this cache, returns {@code -1} if cache is
	 *         unavailable.
	 */
	long getMissCount();
	 ...
	 * 
	 * @return current cached object count of this cache, returns {@code -1} if
	 *         cache is unavailable.
	 */
	long getCachedCount();
