...
public final class Requests {
	 ...
	 * represents "the page size", and the third star represents
	...
	private static final Pattern MOBILE_USER_AGENT_PATTERN = Pattern.compile(
			"android.+mobile|avantgo|bada|blackberry|blazer|compal|elaine|fennec"
					...
					+ "|link)|ucweb|vodafone|wap|webos|windows (ce|phone)|xda|xiino|htc|MQQBrowser", Pattern.CASE_INSENSITIVE);
	/**
	...
	private static final Pattern SEARCH_ENGINE_BOT_USER_AGENT_PATTERN = Pattern.compile(
			"Baiduspider|Googlebot|Feedfetcher-Google|Yahoo|YodaoBot|Sosospider|Sogou|bingbot|adidxbot|msnbot|AppEngine-Google"
					+ "|magpie-crawler|Xianguo.com|RssBandit|Doubanbot", Pattern.CASE_INSENSITIVE);
	/**
