 ...
 * 
 * <p>
 * <b>Note</b>: Remember to {@link Stopwatchs#release() release} a stopwatch if
 * finished statistics finally to avoid memory leak.
 * </p>
 * 
 * <p>
...
public final class Stopwatchs {
	 ...
	 *         {@link Stopwatch#startTime the start time} of the found task if
	 *         it {@link Stopwatch#isRunning() is running}</li>
	 ...
	 * 
	 * <p>
	 * The task for timing is specified by the {@link #taskTitle task title}, if
	 * exists two tasks with the same title in a task tree,
	 * </p>
	 * 
	 * @author <a href="mailto:DL88250@gmail.com">Liang Ding</a>
	...
	private static class Stopwatch {
		 ...
		 * 
		 * @return elapsed time, {@link #startTime startTime} - {@link #endTime
		 *         endTime}
		 */
		...
		public String toString() {
			...
			final StringBuilder stringBuilder = new StringBuilder("[").append(percenOfRoot).append("]%, [").append(getElapsedTime())
					.append("]ms [").append(getTaskTitle()).append("]").append(Strings.LINE_SEPARATOR);
